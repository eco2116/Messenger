...
From there, the various commands are as described in the assignment. I attempted to implement the
privacy and consent bonus for P2P. In order to test that feature, when user one requests the address of
